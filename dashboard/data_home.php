                ...
                <div class="row">
                    <div class="col-12">
                        <div class="form-home-page-cms">
                            ...
                            if(isset($_POST['simpan'])){
                                if(homePage($_POST) > 0) {
                                    ...
                                    document.addEventListener('DOMContentLoaded', function() {
                                        location.reload(alert('Data berhasil di ubah'));
                                    });
                                    </script>
                                    <?php
                                }else {
                            ...
                            <div class="mb-4">
                             <label for="exampleFormControlInput1" class="form-label">Judul hero</label>
                             <textarea type="text" class="form-control" name="title_hero" id="exampleFormControlInput1" required><?= $rows['title_hero']; ?></textarea>
                             </div>
                             <div class="mb-4">
                             <label for="exampleFormControlTextarea1" class="form-label">Deskripsi hero</label>
                             <textarea type="text" class="form-control" name="desc_hero" id="exampleFormControlInput1" required><?= $rows['desc_hero']; ?></textarea>
                             </div>
                             <div class="mb-4">
