      ...
      <main>
        <section class="dashboard">
            <div class="container content-dashboard">
                <?php 
                $id = $_GET['id'];
                $result = mysqli_query($conn, "SELECT * FROM proyek WHERE id='$id'");
                    ...
                    <div class="col-12">
                        <div class="form-home-page-cms">
                            ...
                            <form action="" method="post" enctype="multipart/form-data">
                                ...
                                <input type="hidden" name="image_lama" value="<?= $rows['image_proyek']; ?>">
                             <div class="mb-4">
                             <label for="exampleFormControlTextarea1" class="form-label">Judul</label>
                             <textarea type="text" class="form-control" name="title_proyek" id="exampleFormControlInput1" required><?= $rows['title_proyek']; ?></textarea>
                             </div>
                             <div class="mb-4">
                                <label for="formFile" class="form-label">Gambar</label>
                                <input class="form-control" type="file" value="<?= $rows['image_proyek']; ?>" name="image_proyek" id="formFile">
                             </div>
                             <div class="mb-4">
                                ...
                                <select class="form-select" name="kategori_proyek" id="kategori_proyek" aria-label="Default select example" required>
                                  <option selected><?= $rows['kategori_proyek']; ?></option>
                             ...
                             <div class="mb-4">
                                ...
                                <input class="form-control" type="text" value="<?= $rows['link_proyek']; ?>" name="link_proyek" id="formFile" required>
                             </div>
                             <div class="mb-4">
